...
ggsave(sse.plot, width = 8, height = 8, file = "../sse.plot.pdf")
ggsave(sse.plot2, width = 10, height = 8, file = "../sse.plot.reg.pdf")
ggsave(sse.plot3, width = 10, height = 8, file = "../sse.plot.hist.pdf")
